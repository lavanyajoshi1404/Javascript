// Immediately Invoked Function Expresssion (IIFE)- due to global scope many times pollution is caused and to avvvoid that iife is used
(function db (){
    //named iife
    console.log(`DB CONNECTED`);
})();
// to end iife semicolon is necessary at the end
// Now iife using arrow function
( (name) => {
    //unnamed iffe for writing two iife semicolon is required at end
